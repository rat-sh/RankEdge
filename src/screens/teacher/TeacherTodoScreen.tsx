...
const TeacherTodoScreen = () => {
  const [todos, setTodos] = useState<TodoItem[]>([
    { id: '1', text: 'Review pending assignments', done: false, priority: 'urgent' },
    { id: '2', text: 'Answer unresolved doubts', done: false, priority: 'urgent' },
    { id: '3', text: 'Schedule next exam', done: false, priority: 'normal' },
  ]);
...
const s = StyleSheet.create({
  ...
  addBtn: { paddingHorizontal: 18, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: '#3B82F6' },
